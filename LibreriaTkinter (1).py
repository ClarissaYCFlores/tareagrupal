...
class Campo(object):
    ...
    def combobox(self, valor, modo=False):
        ...
        self.box = tkinter.ttk.Combobox(self.padre,
...
if __name__ == '__main__':
    ...
    form = Formulario(raiz, [
                             ["Nombres", "entry", "", False],
                             ["Apellidos", "entry", "", False],
                             ["Carreras", "combobox", ['Ing. Sistemas', 'Lic. Matematicas', 'Ing. Electronica'],
                              False],
                             ["Fecha Nacimiento", "entry", "", False]
